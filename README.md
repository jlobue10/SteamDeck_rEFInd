...
## SteamOS 3.5 seems to have broken quite a bit with the installer. I'm actively debugging and looking to repackage the whole process (probably into a flatpak). Stay tuned...
